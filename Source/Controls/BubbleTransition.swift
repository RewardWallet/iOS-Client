...
open class BubbleTransition: NSObject, UIViewControllerAnimatedTransitioning, UIViewControllerTransitioningDelegate {
        ...
        if !self.isReverse {
            UIView.transition(with: animatedViewForTransition,
                              ...
                              animations: {
                                ...
                                presentedController.setNeedsStatusBarAppearanceUpdate()
            },
                              completion: { (_) in
            })
